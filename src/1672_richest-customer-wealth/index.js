const sumNumbers = numbers => numbers.reduce((total, num) => total + num, 0)
 ...
 * @return {number}
 */
exports.maximumWealth = function maximumWealth (accounts) {
  return Math.max(...accounts.map(sumNumbers))
}
